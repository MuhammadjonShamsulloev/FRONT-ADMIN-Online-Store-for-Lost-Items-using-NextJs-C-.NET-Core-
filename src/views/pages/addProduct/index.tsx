...
export const AddProduct: React.FC = (): JSX.Element => {
  ...
  const [price, setPrice] = React.useState<string>('+992');
  const [discount, setDiscount] = React.useState<string>('0');
  const [vendorcode, setVendorcode] = React.useState<string>('0');
  ...
  return (
    <Page title="Add product">
      <MainLayout>
        <h1 className="title mb-3">Add product</h1>
        ...
        <div className="form characteristics-form">
          ...
          <div className="form__label">
            <div className="form__label-name">Add more photos</div>
...
{/* 
          ...
          <div className="form__label">
            <div className="form__label-name">Brend</div>
            <DropdownMenu
              id="categoryId"
              value={brand?.name || ''}
          ...
          <div className="form__label">
            <div className="form__label-name">Description</div>
